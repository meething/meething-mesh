...
export default class UEX {
    ...
    initialRegister() {
        ...
        */
        ...
        document.querySelector('#color-switcher').addEventListener('change', function(ev) {
            if (this.checked) {
                document.getElementsByTagName("html")[0].classList.value = "theme-alternative"
            } else {
                document.getElementsByTagName("html")[0].classList.value = "theme-meething"
            }
        });
    }
